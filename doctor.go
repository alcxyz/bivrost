...
func platformDoctor(ctx context.Context, c config, out io.Writer) error {
	return platformDoctorWithSession(ctx, c, out, nil)
}

func platformDoctorWithSession(ctx context.Context, c config, out io.Writer, session *doctorSessionStatus) (resultErr error) {
