...
| [0004](0004-terraform-baseline.md) | Terraform baseline and local Azure discovery | Accepted; baseline on `dev` |
| [0005](0005-session-runtime-metadata.md) | Heimdal session-only runtime metadata | Accepted; initial publication and retrieval on `dev` |
